...
def init_model():
    ...
    parser.add_argument("--bert_model",
                        default="/code/tcw/SFTP/binary_cls/bert-snips", type=str,
    ...
    parser.add_argument("--dataset", default='snips', type=str,
    ...
    parser.add_argument("--alpha", type=float, default=0.7, help="The learning rate of the decision boundary.")

    parser.add_argument("--t", type=float, default=3., help="The learning rate of the decision boundary.")

    parser.add_argument("--r", type=float, default=40., help="The learning rate of the decision boundary.")

    parser.add_argument("--m", type=float, default=0.4, help="The learning rate of the decision boundary.")
